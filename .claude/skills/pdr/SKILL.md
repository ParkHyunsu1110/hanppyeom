...
- 신규 기능·화면·API·모듈을 만든다. (예: Firebase Auth 로그인 화면, Firestore 기반 데이터 모델)
...
- 기본 위치는 `docs/design-reviews/<slug>.md`. slug는 변경 단위(예: `auth-email-login`, `diary-firestore-model`).
